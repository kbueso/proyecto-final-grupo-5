    ...
    render() {
        ...
        return (
            <div>
                ...
                <p>Selecione una imagen de alimentos </p>

                <Form>
                    <FormGroup>
                        <div>
                            <p>Selecione un URL de muestra o pegue uno en barra de busqueda</p>
                            <div>

                                <UncontrolledDropdown >
                                    <DropdownToggle caret>
                                        URL imagen de muestra
                                    </DropdownToggle>
                                    <DropdownMenu>
                                        {sampleImages.map(si =>
                    ...
                    <FormGroup id={"upload_button"}>
                        ...
                        <Label for="imageUpload">
                            ...
                            <span className="btn btn-primary">Subir</span>
                        </Label>
                    </FormGroup>
                    ...
                    <FormGroup>
                        <Button color="success" onClick={this._predict}
                                disabled={this.state.isLoading}> Predecir</Button>
                        <span className="p-1 "/>
                        <Button color="danger" onClick={this._clear}> Limpiar</Button>
                    </FormGroup>
